...
public class TestDepartmentDatabaseEntryMapper {
    ...
    @Test
    public void testDepartmentDatabaseEntryMapper_FromDatabaseEntryToDepartment()
    {
    ...
    @Test
    public void testDepartmentDatabaseEntryMapper_FromDepartmentToDatabaseEntry()
    {
    ...
    @Test
    public void testDepartmentDatabaseEntryMapper_FromDepartmentEntryListToDepartmentList()
    {
