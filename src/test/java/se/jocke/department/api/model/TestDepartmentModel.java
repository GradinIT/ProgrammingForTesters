...
public class TestDepartmentModel {
    ...
    public void testThatDepartmentIsCreated () {
        ...
        String DEPARTMENT_MODEL_TO_STRING_VALUE = DEPARTMENT_MODEL.toString();
        String department_model_to_string_value = departmentModel.toString();
        Assertions.assertEquals(DEPARTMENT_MODEL_TO_STRING_VALUE,department_model_to_string_value);
