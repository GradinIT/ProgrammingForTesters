...
import se.jocke.SpringTestConfig;
...
@SpringBootTest(classes = {RestServiceApplication.class, LiquibaseConfigurer.class, H2JpaConfig.class , SpringTestConfig.class},
