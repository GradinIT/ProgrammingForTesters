...
public class TestEmployeePojoMapper {
    ...
    @Test
    @DisplayName("Map employeeDatabaseEntry to employee")
    ...
    @Test
    @DisplayName("Map employee to employeeDatabaseEntry")
    ...
    @Test
    @DisplayName("Map list of employeeDatabaseEntry to list of employees")
