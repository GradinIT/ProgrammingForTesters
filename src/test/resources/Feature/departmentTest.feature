...
Feature: test department api
  ...
  Scenario: client deletes department
    ...
    And  the department error message is 404 : [Entity with id 55 not found]
    Then the department 56 is deleted
    And  the department error message is 404 : [Entity with id 56 not found]
    Then the department 57 is deleted
    And  the department error message is 404 : [Entity with id 57 not found]
