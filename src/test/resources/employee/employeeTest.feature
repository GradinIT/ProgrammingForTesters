Feature: test employee api
  ...
  Scenario: client gets Employee 1
    ...
    Then the name is robin, hood, 34000, true, 44
  ...
  Scenario: client gets Employee 1
    When the client gets employee 1
    Then the name is firstName1, lastName1, 25000.00, true, 1

  Scenario: client gets Employee 2
    When the client gets employee 2
    Then the name is firstName2, lastName2, 25000.00, true, 1
  ...
  Scenario: client gets Employee 3
    ...
    Then the name is Alex3, Ek3, 34321.50, true, 303034
  ...
  Scenario: client gets Employee 3
    When the client gets employee 3
    Then the name is firstName3, lastName3, 25000.00, true, 1
  ...
  Scenario: client tries to delete non-existant employee
    ...
    And  the error message is 404 : [Entity with id 200 not found]